...
import { TapTrading } from './components/TapTrading';
...
function App() {
  ...
  const [showTapTrading, setShowTapTrading] = useState(false);
  ...
  return (
    <>
              ...
              {isPreLaunch ? (
                ...
                <>
                  ...
                  <div className="trade-right">
                    <TradingPanel token={selectedToken} positions={mockPositions} onOpenTapTrading={() => setShowTapTrading(true)} />
                  </div>
                </>
              )}
            </div>
      ...
      {/* Fullscreen Tap Trading Modal */}
      {showTapTrading && (
        <TapTrading 
          token={selectedToken} 
          onClose={() => setShowTapTrading(false)} 
        />
      )}
    </>
  );
